...
showToken Core.TkMutual = "'mutual'"
showToken Core.TkUniTensor = "'⊗'"
showToken Core.TkTimes = "'×'"
showToken Core.TkAmpersand = "'&'"
showToken Core.TkLeftAngle = "'⟨'"
showToken Core.TkRightAngle = "'⟩'"
showToken Core.TkHashAttributes = "'#attributes'"
